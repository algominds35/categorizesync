...
export function TransactionReviewList({ transactions, clientId }: TransactionReviewListProps) {
    ...
    try {
      const response = await fetch('/api/transactions/approve', {
        ...
        body: JSON.stringify({
          ...
          accountName: transaction.aiAccountName,
          className: transaction.aiClassName,
        }),
      })
